...
import { actByDescriptionFetch, actByIdFetch, actividadesFetch, addActividadFetch, actividadUpdateFetch, actividadDeleteFetch } from "../fetchs";
...
export const deleteActividad =
    ...
    (action) => {
        ...
        if (action.type === DELETE_ACTIVIDAD) {
            dispatch(RESTDelete(actividadDeleteFetch, action.id, DELETE_ACTIVIDAD_SUCCESS, DELETE_ACTIVIDAD_ERROR, ""));
        }
    };

export const middleware = [getActividades, getByDescription, getById, addActividad, updateActividad, deleteActividad];
