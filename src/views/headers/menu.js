    ...
    render() {
        return html`
            ...
            <div id="opciones" class="grid column" @click=${this.toggleMenu}>
                ...
                <button link ?selected="${this.selectedOption[3]}" @click=${this.click} .option=${"Empresas"}>FORMULARIO</button>
                <button link ?selected="${this.selectedOption[4]}" @click=${this.click} .option=${"Demo"}>DEMO</button>
